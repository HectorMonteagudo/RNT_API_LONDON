...
namespace RNT_APIREST_LONDON.Repositorios
{
    ...
    public class VariedadRepository : IVariedadRepository
    {
        ...
        public VariedadRepository(IConfiguration configuration)
        {
        ...
        public async Task<GenericoDtoResponse> ObtenerAsync()
        {
            ...
            try
            {
                query = "select \"Code\" as \"Codigo\",\"Name\" as \"Descripcion\" from \"@RNT_VARIEDAD\"";
            ...
            catch (Exception ex)
            {
                ...
                response.ErrorMessage = $"Error al obtener las Variedades: {ex.Message}.";
                throw;
            }
